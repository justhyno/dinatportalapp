...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof mz.gov.mta.dndt.service.EmailAlreadyUsedException ||
            ex instanceof mz.gov.mta.dndt.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof mz.gov.mta.dndt.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "mz.gov.mta.dndt");
    }
}
